...
path_hog = 'E:\\TA\\Vehicle Detection\\vehicle_classification\\img_dataset\\hog_16x16'
...
#                file = random.choice(os.listdir(img_dir))
                if file.endswith(".jpg"):
                    ...
                    hog_hist, hog_img = hog(gray, pixels_per_cell=(8, 8), cells_per_block=(1, 1), nbins=9, visualize=True, normalise=True, feature_vector=True)
...
hog_model_64.fit(scaled_hog_64, label_64)
lbp_model_64.fit(scaled_lbp_64, label_64)
hog_lbp_model_64.fit(scaled_hog_lbp_64, label_64)
hog_model_32.fit(scaled_hog_32, label_32)
lbp_model_32.fit(scaled_lbp_32, label_32)
hog_lbp_model_32.fit(scaled_hog_lbp_32, label_32)

score_hog_64 = cross_val_score(hog_model_64, scaled_hog_64, label_64, cv=10)
score_lbp_64 = cross_val_score(lbp_model_64, scaled_lbp_64, label_64, cv=10)
score_hog_lbp_64 = cross_val_score(hog_lbp_model_64, scaled_hog_lbp_64, label_64, cv=10)
score_hog_32 = cross_val_score(hog_model_32, scaled_hog_32, label_32, cv=10)
score_lbp_32 = cross_val_score(lbp_model_32, scaled_lbp_32, label_32, cv=10)
score_hog_lbp_32 = cross_val_score(hog_lbp_model_32, scaled_hog_lbp_32, label_32, cv=10)

print "Test Accuracy of scaled HOG for 64x64 images = %0.4f (+/- %0.4f)"%(score_hog_64.mean(), score_hog_64.std()*2)
print "Test Accuracy of scaled LBP for 64x64 images = %0.4f (+/- %0.4f)"%(score_lbp_64.mean(), score_lbp_64.std()*2)
print "Test Accuracy of scaled HOG+LBP for 64x64 images = %0.4f (+/- %0.4f)"%(score_hog_lbp_64.mean(), score_hog_lbp_64.std()*2)
print "Test Accuracy of scaled HOG for 64x32 images = %0.4f (+/- %0.4f)"%(score_hog_32.mean(), score_hog_32.std()*2)
print "Test Accuracy of scaled LBP for 64x32 images = %0.4f (+/- %0.4f)"%(score_lbp_32.mean(), score_lbp_32.std()*2)
print "Test Accuracy of scaled HOG+LBP for 64x32 images = %0.4f (+/- %0.4f)"%(score_hog_lbp_32.mean(), score_hog_lbp_32.std()*2)

print score_hog_64
print score_lbp_64
print score_hog_lbp_64
print score_hog_32
print score_lbp_32
print score_hog_lbp_32

#print "save SVM models to directory..."
#with open('svm_classifiers_new/scaled_hog_model_64.p', 'wb') as f:
#	pickle.dump(hog_model_64, f)
#with open('svm_classifiers_new/scaled_lbp_3x3_model_64.p', 'wb') as f:
#	pickle.dump(lbp_model_64, f)
#with open('svm_classifiers_new/scaled_hog_lbp_3x3_model_64.p', 'wb') as f:
#	pickle.dump(hog_lbp_model_64, f)
#with open('svm_classifiers_new/hog_scaler_64.p', 'wb') as f:
#	pickle.dump(hog_scaler_64, f)
#with open('svm_classifiers_new/lbp_3x3_scaler_64.p', 'wb') as f:
#	pickle.dump(lbp_scaler_64, f)
#with open('svm_classifiers_new/hog_lbp_3x3_scaler_64.p', 'wb') as f:
#	pickle.dump(hog_lbp_scaler_64, f)
#with open('svm_classifiers_new/scaled_hog_model_32.p', 'wb') as f:
#	pickle.dump(hog_model_32, f)
#with open('svm_classifiers_new/scaled_lbp_3x3_model_32.p', 'wb') as f:
#	pickle.dump(lbp_model_32, f)
#with open('svm_classifiers_new/scaled_hog_lbp_3x3_model_32.p', 'wb') as f:
#	pickle.dump(hog_lbp_model_32, f)
#with open('svm_classifiers_new/hog_scaler_32.p', 'wb') as f:
#	pickle.dump(hog_scaler_32, f)
#with open('svm_classifiers_new/lbp_3x3_scaler_32.p', 'wb') as f:
#	pickle.dump(lbp_scaler_32, f)
#with open('svm_classifiers_new/hog_lbp_3x3_scaler_32.p', 'wb') as f:
